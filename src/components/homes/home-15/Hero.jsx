...
export default function Hero({ heroItems }) {
      ...
      <div className="swiper-container swiper-hero dots-over relative z-10">
        ...
        >
          {heroItems
            ...
            .map((item, index) => {
              const alignmentClasses = item.type === 'banner'
                ? 'md:w-10/12 lg:w-8/12 xl:w-7/12 !mx-auto text-center' 
                : 'md:w-10/12 md:!ml-[8.33333333%] lg:w-7/12 lg:!ml-0 xl:w-6/12 xxl:w-5/12 text-center lg:text-left'; 
                ...
                >
                  <div className="container !h-full">
                    <div className="flex flex-wrap mx-[-15px] !h-full">
                      <div className={`w-full flex-[0_0_auto] !px-[15px] max-w-full justify-center self-center ${alignmentClasses}`}>
